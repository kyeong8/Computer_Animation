...
init()
{
	...
	cout << "Keyboard Input: d for the Mid point integration" << endl;
...
keyboard(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	if (action == GLFW_PRESS || action == GLFW_REPEAT)
	{
		...
		case GLFW_KEY_E:		intMethod = EULER;			cout << "Euler integration" << endl; break;
		case GLFW_KEY_M:		intMethod = MODIFIED_EULER;	cout << "Modified Euler integration" << endl; break;
		case GLFW_KEY_D:		intMethod = MID_POINT;		cout << "Mid point integration" << endl; break;
		}
	}
}
